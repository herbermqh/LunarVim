...
|`:SudoWrite`|                                                                 [Vim-Eunuch](https://github.com/tpope/vim-eunuch) plugin : Write even if you don't have permission|
|__Motion/Movement__|`:h motion.txt`|
...
|__Text Objects__|`:h text-objects`|
...
|__Formatting__|`:h formatoptions`|
...
<td colspan=2>A query to increment value in whole file<br/>`:let i=1 \| g/foo/s//\=i/ \| let i=i+1`<br/>For example:<br/>`:let i=1 \| g/foo/s//\="morestuff".i."morestuff"/ \| let i=i+1`</td>
|__Function Keys__||
