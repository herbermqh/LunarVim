...
hi Comment         guifg=#7f9f7f gui=bold
hi Conditional     guifg=#f0dfaf gui=bold
hi Constant        guifg=#ffa3a3 gui=bold
...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    hi TabLine       guifg=#505058 guibg=#000000 gui=none
