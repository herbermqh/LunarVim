...
badd +397 .config/LunarVim/user.vim
badd +40 .config/LunarVim/lv-settings.lua
badd +126 .config/LunarVim/lua/plugins.lua
badd +479 .config/LunarVim/lua/lv-galaxyline/init.lua
...
230
normal! zo
let s:l = 242 - ((70 * winheight(0) + 18) / 36)
